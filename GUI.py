...
class Gui:
    def __init__(self):
        ...
        col1 = [[sg.Text('Assessment:', font=('Helvetica',13,'bold'))],
        ...
        col2 = [[sg.Text(' ')],[sg.Text('Targeted:', font=('Helvetica',13,'bold'))],
               ...
               [sg.Text('->'),sg.Checkbox(' Legion', size=(9,1),default=True, key='-tool6-')],
        ...
        self.window=sg.Window('PenTasker   -   v. 1.0', layout, resizable=True, element_justification='c', font=("Helvetica", 12),icon='Images/PenTasker-icon.png')
    ...
    def __init__(self,filename):
        ...
        for X in data['tabs']:
            ...
            for Y in X['output']: # port=Y[0] , output=Y[1] 
                port=Y[0]
                out=Y[1]
                tab=sg.Tab(layout=[[sg.Multiline("\n  "+out.replace("\n","\n  "),background_color="white",text_color="black",pad=(0,0), size=(180,35), disabled=True)],],title=port, background_color="white", pad=(20,20))
                tabs.append(tab)
        ...
        layout2 = [[sg.TabGroup([ tabsX ])],
              [sg.Button('Generate\nReport', button_color=('white', 'springgreen4'), size=(18,2), font='Helvetica 14')], [sg.Button('Close')]]

        self.window=sg.Window('PTSK Project', layout2, resizable=True, element_justification='c', font=("Helvetica", 12),icon='Images/PenTasker-icon.png')
